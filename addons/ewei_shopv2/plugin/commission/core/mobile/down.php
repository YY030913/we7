...
class Down_EweiShopV2Page extends CommissionMobilePage
{
	...
	'pagesize' => $psize
		...
		$list = pdo_fetchall('select * from ' . tablename('ewei_shop_member') . ' where uniacid = ' . $_W['uniacid'] . ' ' . $condition . '  ORDER BY id desc limit ' . (($pindex - 1) * $psize) . ',' . $psize);
