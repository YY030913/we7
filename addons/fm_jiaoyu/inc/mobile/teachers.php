 ...
 */
        ...
        $list = pdo_fetchall("SELECT * FROM " . tablename($this->table_teachers) . " WHERE weid = '{$_W['uniacid']}' AND schoolid ={$schoolid} AND is_show = 0 ORDER BY jiontime ASC", array(':weid' => $_W['uniacid'], ':schoolid' => $schoolid, ':is_show' => 0));
