...
//require IA_ROOT. '/addons/fm_jiaoyu/inc/version.php';
load()->model('reply');
load()->app('common');
...
if (empty($oauthurl)) {
	...
	$log = file_get_contents(IA_ROOT . "/addons/fm_jiaoyu_oauth/update.php");
	$upgradeall = file_get_contents(IA_ROOT . "/addons/fm_jiaoyu_oauth/upgrade.php");
	...
	$fmpath = IA_ROOT . '/addons/fm_jiaoyu';
	if ($_GPC['type'] == 'check') {
